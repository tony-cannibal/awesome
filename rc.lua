...
globalkeys = mytable.join(
    ...
    -- Layout manipulation
    awful.key({ modkey, "Shift"   }, "u", function () awful.client.cycle(true)    end,
              {description = "swap with next client by index", group = "client"}),
    awful.key({ modkey, "Shift"   }, "d", function () awful.client.cycle(false)    end,
              {description = "swap with previous client by index", group = "client"}),
  ...
  -- Dynamic tagging
    ...
    awful.key({ modkey }, "x",
              function ()
                  awful.spawn.with_shell("~/.config/awesome/scripts/dmenu-power.sh")
              end,
